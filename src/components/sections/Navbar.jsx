...
export default function Navbar() {
  return (
    <nav className="flex justify-between items-center py-8 border-b border-slate-800/60 mb-0 sticky top-0 z-50 backdrop-blur-md bg-bg/80">
      ...
      <a
        href="#contact"
        className="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-accent-500 transition-colors shadow-[0_0_16px_rgba(132,190,194,0.3)]"
      >
        Get in Touch
      </a>
    </nav>
